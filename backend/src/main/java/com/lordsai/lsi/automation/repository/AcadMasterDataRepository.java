...
public interface AcadMasterDataRepository extends JpaRepository<AcadMasterData, Long> {
    List<AcadMasterData> findByCategoryOrderByDisplayOrderAscLabelAsc(String category);
    Optional<AcadMasterData> findByCategoryAndCodeIgnoreCase(String category, String code);
}
