...
public interface AcadBatchRepository extends JpaRepository<AcadBatch, Long> {
    Optional<AcadBatch> findByNameIgnoreCase(String name);
    List<AcadBatch> findAllByOrderByDisplayOrderAscNameAsc();
}
