...
public class AdminStoryController {
    ...
    public ApiResponse<AdminStory> create(@Valid @RequestBody StoryRequest body, HttpServletRequest req) {
        ...
        public ApiResponse<AdminStory> createWithFiles(@RequestParam StoryCategory category,
        ...
        return ApiResponse.ok("Story video uploaded successfully.",
            storyService.createWithFiles(category, title, personName, location, description,
                coverImage, video, actor(), RequestUtil.clientIp(req)));
        }
