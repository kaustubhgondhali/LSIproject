...
public class UserService {
    ...
    public record StudentCreation(User user, StudentProfile profile, boolean created) {
    }
    ...
    public StudentCreation findOrCreateStudent(String fullName, String email, String mobile) {
        ...
        if (existing.isPresent()) {
            ...
            return new StudentCreation(user, profile, false);
        }
        ...
        return new StudentCreation(user, profile, true);
    }
    ...
    public StudentCreation createStudentByAdmin(String fullName, String email, String mobile,
        ...
        user.setAccountStatus(AccountStatus.PENDING_SETUP);
        user = userRepository.save(user);
        return new StudentCreation(user, attachProfile(user, batch, location), true);
    }
